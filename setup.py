...
# TODO: Change lambda-name
lambda_name = 'urban-dictionary-skill'
...
lambda_description = 'Lambda that returns risk score for one vehicle'
...
# Who is the author?
lambda_author = 'Sam Mahr'
lambda_author_email = 'samuelmahr@gmail.com'
...
setup(
    ...
    install_requires=list(filter(lambda x: x not in ['boto3', 'botocore'], lambda_install_requires)),
